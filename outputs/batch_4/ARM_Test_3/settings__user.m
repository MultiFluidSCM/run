...
settings.model.constants.param.MYNN.B2 = 0.1;
...
settings.model.constants.param.instab.bentrainu = 1.2;
...
settings.model.constants.param.instab.bdetrainu = 1.2;
%-----------------------------------------------%
...
settings.model.constants.param.mix.bentrainu = 1.2;
...
settings.model.constants.param.mix.bdetrainu = 1.2;
%-----------------------------------------------%
...
settings.model.constants.param.mix_cloud.bentrainu = 1.2;
settings.model.constants.param.mix_cloud.bdetrainw = 1.0; 
settings.model.constants.param.mix_cloud.bdetraint = 1.0;
settings.model.constants.param.mix_cloud.bdetrainq = 0.8;
settings.model.constants.param.mix_cloud.bdetrainu = 1.2;
%-----------------------------------------------%
...
settings.model.constants.param.dwdz.bentrainu = 1.2;
...
settings.model.constants.param.dwdz.bdetrainu = 1.2;
%-----------------------------------------------%
