...
settings.model.constants.param.MYNN.A2 = 0.35;
settings.model.constants.param.MYNN.B1 = 1.5;
settings.model.constants.param.MYNN.B2 = 1;
...
settings.model.constants.param.instab.bentrainw = 0.4;
settings.model.constants.param.instab.bentraint = 1.0;
settings.model.constants.param.instab.bentrainq = 0.6;
...
settings.model.constants.param.dwdz.entrain_factor = 0;
settings.model.constants.param.dwdz.detrain_factor = 1.0;
% Factors for transferred properties 
% Vertical velocity, eta, water, and u & v.
