...
% param.bentraint = 1.0;     % Factor for entrainment of eta
% param.bentrainq = 0.1;     % Factor for entrainment of water
% param.bentrainu = 0.2;     % Factor for detrainment of u and v

param.bentrainw = 0.7;     % Factor for entrainment of w
param.bentraint = 1.0;     % Factor for entrainment of eta
param.bentrainq = 0.7;     % Factor for entrainment of water
param.bentrainu = 0.7;     % Factor for detrainment of u and v
...
% param.bdetrainu = 0.8;     % Factor for detrainment of u and v

param.bdetrainw = 0.7;     % Factor for detrainment of w
param.bdetraint = 1.0;     % Factor for detrainment of eta
param.bdetrainq = 0.7;     % Factor for detrainment of water
