...
% variables = [...
	% gradient_variable("mix detrain bw",    "bwMixD", 0.5, 1.0, bwMixD, -0.1), ...
	% gradient_variable("mix detrain bt",    "btMixD", 0.5, 1.0, btMixD, -0.1), ...
	% gradient_variable("mix detrain bq",    "bqMixD", 0.5, 1.0, bqMixD, -0.1), ...
	% gradient_variable("mix entrain bw",    "bwMixE", 0.5, 1.0, bwMixE,  0.1), ...
	% gradient_variable("mix entrain bt",    "btMixE", 0.5, 1.0, btMixE, -0.1), ...
	% gradient_variable("mix entrain bq",    "bqMixE", 0.5, 1.0, bqMixE, -0.1), ...
	...
	% gradient_variable("instab entrain bq", "bqInsE", 0.5, 1.0, bqInsE, -0.1), ...
    % gradient_variable("dwdz detrain bw",   "bwDwzD", 0.5, 1.0, bwDwzD,  0.1), ...
	% gradient_variable("dwdz detrain bt",   "btDwzD", 0.5, 1.0, btDwzD, -0.1), ...
...
variables = [...
	gradient_variable("mix entrain detrain bw",    "bwMixDE", 0., 1.0, bwMixD, -0.1), ...
	gradient_variable("mix entrain detrain bt",    "btMixDE", 0., 1.0, btMixD, -0.1), ...
	gradient_variable("mix entrain detrain bq",    "bqMixDE", 0., 1.0, bqMixD, -0.1), ...
    gradient_variable("instab dwdz entrain detrain bw",   "bwDwzDE", 0., 1.0, bwDwzD,  0.1), ...
	gradient_variable("instab dwdz entrain detrain bt",   "btDwzDE", 0., 1.0, btDwzD, -0.1), ...
	gradient_variable("instab dwdz entrain detrain bq",   "bqDwzDE", 0., 1.0, bqDwzD, -0.1), ...
	gradient_variable("dwdz detrain factor", "dwdzFacD", 1.0, 2.0, dwdzFacD, 0.1)
];
