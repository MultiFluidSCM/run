...
sensitivities = [0., -0.01, 0.01, -0.02, 0.02, -0.03, 0.03];
...
variables{end+1} = sensitivity_variable("mix cloud entrain bw", "bwMicE", bwMicE, sensitivities);
...
% variables{end+1} = sensitivity_variable("instab entrain factor", "insFacE", insFacE, sensitivities);
...
% variables{end+1} = sensitivity_variable("MYNN A1",              "mynnA1", mynnA1, sensitivities);
% variables{end+1} = sensitivity_variable("MYNN A2",              "mynnA2", mynnA2, sensitivities);
% variables{end+1} = sensitivity_variable("MYNN B1",              "mynnB1", mynnB1, sensitivities);
variables{end+1} = sensitivity_variable("MYNN B2",              "mynnB2", mynnB2, sensitivities);
